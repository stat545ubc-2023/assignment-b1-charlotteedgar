...
The third example will demonstrate what happens if a dataset including a non-numeric column is inputted as the argument into our new function. The simple dataset is made with 2 columns where the first column is numeric using seq() from 1 to 10 and the second is a vector of characters. 
```{r}
col1 <- seq(1,10,length = 26)
dataset3 <- cbind(seq(1,10,length = 26), paste0(letters))
head(dataset3)
